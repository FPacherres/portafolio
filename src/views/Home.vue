...
.down {
  ...
  font-size: 12px;
  animation: 1s move-arrow-down 3.5s linear infinite;
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 10px;
...
.avatar {
  animation: 1s animationAvatar 3.5s ease-in;
}
...
section .mySelf .mainText {
  z-index: 2;
  display: grid;
  animation: 1s animationMainText 3.5s ease-in;
}
